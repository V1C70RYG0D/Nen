...
describe('AIServiceIntegration', () => {
    let aiService;
    beforeEach(() => {
        aiService = new AIServiceIntegration_1.AIServiceIntegration();
        jest.clearAllMocks();
    });
    describe('Service Initialization', () => {
        test('should initialize with proper configuration', () => {
            expect(aiService).toBeDefined();
            expect(aiService).toBeInstanceOf(AIServiceIntegration_1.AIServiceIntegration);
        });
    });
    describe('Health Check', () => {
        test('should check AI service health successfully', async () => {
            ...
            expect(axios.get).toHaveBeenCalledWith(expect.stringContaining('/health'), expect.objectContaining({ timeout: 5000 }));
        });
    ...
    describe('AI Move Generation', () => {
        test('should generate move for valid request', async () => {
            ...
            expect(axios.post).toHaveBeenCalledWith(expect.stringContaining('/ai/move'), mockRequest, expect.objectContaining({
                headers: {
    ...
    describe('Agent Training', () => {
        test('should start training session successfully', async () => {
            ...
            expect(axios.post).toHaveBeenCalledWith(expect.stringContaining('/ai/train'), mockTrainingRequest, expect.any(Object));
        });
        test('should get training status', async () => {
            ...
            expect(axios.get).toHaveBeenCalledWith(expect.stringContaining(`/ai/training/${sessionId}`), expect.any(Object));
        });
    });
    describe('Agent Management', () => {
        test('should list available agents', async () => {
            ...
            expect(axios.get).toHaveBeenCalledWith(expect.stringContaining('/ai/agents'), expect.any(Object));
        });
        test('should remove agent successfully', async () => {
            ...
            expect(axios.delete).toHaveBeenCalledWith(expect.stringContaining(`/ai/agents/${agentId}`), expect.any(Object));
        });
...
//# sourceMappingURL=AIServiceIntegration.test.js.map