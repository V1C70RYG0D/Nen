...
app.use('/api/betting', createRateLimiter(60 * 1000, 30, 'Too many betting requests'));
app.use('/api/game', createRateLimiter(60 * 1000, 100, 'Too many game requests'));
...
app.use('/api/v1/users', (0, highPerformance_1.smartCache)(60000), user_1.default);
app.use('/api/v1/ai', (0, highPerformance_1.smartCache)(300000), ai_1.default);
app.use('/api/v1/game', game_1.default);
app.use('/api/v1/nft', (0, highPerformance_1.smartCache)(180000), nft_1.default);
app.use('/api/v1/enhanced', (0, highPerformance_1.smartCache)(120000), enhanced_1.default);
...
app.get('/api/v1/betting/user/:userId', (0, highPerformance_1.smartCache)(30000), async (req, res, next) => {
    try {
