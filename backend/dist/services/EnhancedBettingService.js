...
class EnhancedBettingService {
    ...
    constructor() {
        this.config = {
            minBetAmount: parseInt(process.env.MIN_BET_LAMPORTS || '10000000'),
            maxBetAmount: parseInt(process.env.MAX_BET_LAMPORTS || '1000000000'),
            ...
            dailyBetLimit: parseInt(process.env.DAILY_BET_LIMIT_LAMPORTS || '10000000000'),
            monthlyBetLimit: parseInt(process.env.MONTHLY_BET_LIMIT_LAMPORTS || '100000000000')
        };
        ...
        try {
            ...
            for (const bet of winningBets) {
                try {
                    ...
                    const totalPayout = bet.amount + prize;
    ...
    createBetEscrow(bettorWallet, amount) {
        try {
            ...
            const escrowKey = web3_js_1.PublicKey.findProgramAddressSync([seed.slice(0, 32)], new web3_js_1.PublicKey(process.env.SOLANA_PROGRAM_ID))[0];
