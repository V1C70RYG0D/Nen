...
exports.mockPrismaClient = {
    ...
    $transaction: jest.fn().mockImplementation((fn) => fn(exports.mockPrismaClient)),
...
exports.mockEnhancedDatabaseService = {
    ...
    getPrismaClient: jest.fn().mockReturnValue(exports.mockPrismaClient),
    getRedisClient: jest.fn().mockReturnValue(exports.mockRedisClient),
    shutdown: jest.fn().mockResolvedValue(undefined)
};
// Mock the enhanced compliance service
exports.mockEnhancedComplianceService = {
