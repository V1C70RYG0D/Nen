...
export interface INotificationService {
  ...
  sendBulkNotifications(request: IBulkNotificationRequest): Promise<ServiceResponse<{ sent: number; failed: number }>>;
  ...
  retryFailedNotifications(): Promise<ServiceResponse<{ retried: number; succeeded: number }>>;
}
...
// ============================================================================
// FILE/DOCUMENT SERVICE INTERFACES
// ============================================================================
...
export interface IFileService {
  ...
  downloadFile(fileId: string, userId: string): Promise<ServiceResponse<{ stream: ReadableStream; metadata: IFile }>>;
  ...
  getFolderContents(folderId: string, userId: string): Promise<ServiceResponse<{ files: IFile[]; folders: IFolder[] }>>;
  ...
  generatePreview(fileId: string, userId: string): Promise<ServiceResponse<{ url: string; type: 'image' | 'pdf' | 'video' }>>;
  ...
  cleanupDeletedFiles(olderThanDays: number): Promise<ServiceResponse<{ deletedCount: number; freedSpace: number }>>;
}
