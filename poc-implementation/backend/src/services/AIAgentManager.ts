...
export class AIAgentManager {
  ...
  private initializeAgents() {
    ...
    const predefinedAgents: AIAgent[] = [
      new AIAgent({
        id: "netero",
        name: "Isaac Netero",
  ...
  public getAgentById(agentId: string): AIAgent | null {
    return this.agents.get(agentId) || null;
  }

  public calculateElo(agentId: string, result: "win" | "loss" | "draw", opponentElo: number): number {
